...
Every klaim atau informasi dalam jawaban Anda HARUS disertai dengan penanda referensi inline berbentuk [N] di akhir kalimat yang bersumber dari dokumen tersebut, di mana N adalah nomor sumber yang tersedia dalam konteks.
